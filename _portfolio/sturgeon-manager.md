...
{% capture fig_img1 %}
![Foo]({{ '/assets/images/sturgeon/deckhand.jpg' | relative_url }})
{% endcapture %}
...
<object data="https://mochiliu.github.io/assets/images/sturgeon/SturgeonManagerManual.pdf" type="application/pdf" width="100%" height="800px"> 
